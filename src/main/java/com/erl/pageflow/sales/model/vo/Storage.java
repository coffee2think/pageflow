...
public class Storage extends Client {
	...
	private static final long serialVersionUID = -4409294697843797333L;
	
	public Storage() {}
	
	public Storage(int clientId, String category, String clientName, String clientAddress, String clientContact,
	...
	public String toString() {
		return "Storage [clientId=" + super.getClientId() + ", category=" + super.getCategory() + ", clientName=" + super.getClientName()
