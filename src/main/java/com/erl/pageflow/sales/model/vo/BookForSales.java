...
public class BookForSales implements Serializable {

	private static final long serialVersionUID = 6197641294141273041L;
	...
	public BookForSales(int bookId, int writerId, String bookName, String writerName, int bookPriceS, int bookPriceR,
