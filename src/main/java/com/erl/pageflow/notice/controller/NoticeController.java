...
public class NoticeController {
	...
	public ModelAndView noticeDetailMethod(Notice notice, ModelAndView mv, HttpSession session) {

		Notice noticeDetail = noticeService.selectOne(notice.getNoticeId());
