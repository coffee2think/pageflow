...
<script>
    ...
    function addRow(currentIndex) {
    	...
    	// table element 찾기
		const table = document.getElementById('edinsert_table');
		...
		newCell5.innerHTML = '<div class="contents-input-div">'
						+ '<input type="input" name="editState" class="contents-input" value="">'
						+ '</div>';
    ...
    function removeRow(currentIndex) {
    	var trList = $('#edinsert_table').find('tr');
    	if(trList.length > 2) {
	...
	function initRowIndex() {
		var table = document.getElementById('edinsert_table');
	...
	<div id="container">
        ...
        <main class="main-wrapper">
            ...
            <div class="main-container">
                ...
                <form class="input-form" action="edinsert.do" method="post">
                    <!--main-header-bar-->
