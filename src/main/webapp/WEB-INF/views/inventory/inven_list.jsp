...
<script type="text/javascript">
	/* $(function(){
	 ...
	 $('#invenkeyword').on('click', function(){
	 $.ajax({
	 url : 'selectkeyword.do',
	 type: 'post',
	 ...
	 var output = $('.contents-table').html();
	
	 for(var i in jsonObj.list){
	 output += "";
	 }
	 $('.contents-table').html(output);
	 },
	...
	/* 	$(function(){
	 ...
	 $('#invenkeyword').on('click', function(){
	 console.log('sdfsdf');
	 //var selectedOptionValue = $("#sel_code").val();
	 //console.log("선택된 옵션의 값: " + selectedOptionValue);
	 //return false;	
	 });
	 })
	 */
	 var curinput; // 
	function invenkeyword() {
		curinput = document.getElementById("someInput").value;
		var selectedOptionValue = $("#sel_code").val();

		// 키워드 입력값 가져오기
		var keywordValue = $(".search-box-text").val();

		// 이제 선택된 옵션과 키워드를 사용하여 원하는 작업을 수행
		// 예: AJAX 요청 보내기 또는 다른 작업 수행
		console.log("선택된 옵션의 값: " + selectedOptionValue);
		console.log("키워드: " + keywordValue);
	}
</script>
<title></title>
							...
							<div class="select-search">
								...
								<div class="search-box">
									...
									<input type="text" placeholder="키워드를 입력하세요."
										class="search-box-text" name="keyword"> <input
											...
											<td class="td-155">
												<div class="contents-input-div">
													<input type="input" name="bookId"
														class="contents-input noline" value="${ inv.bookId }">
												</div>
											</td>
											<td class="td-250">
												<div class="contents-input-div">
													<input type="input" name="bookName"
														class="contents-input noline" value="${ inv.bookName }">
												</div>
											</td>
											<td class="td-70">
												<div class="contents-input-div">
													<input type="input" name="clientName"
														class="contents-input noline" value="${ inv.storageName }">
												</div>
											</td>
											<td class="td-105">
												<div class="contents-input-div">
													<input type="input" name="classify"
														class="contents-input noline" value="${ inv.classify }">
												</div>
											</td>
