...
<script>
    ...
    function listPage() {
        ...
        window.location.href = 'mnlist.do'; 
    ...
    function onDelete(empId) {
        // 퇴사 요청 처리
        	  window.location.href = 'empdelete.do?empId=' + empId;
    }
					...
					<form class="search-form" action="enamesearch.do" method="post">
						...
						<div class="select-search">
							<div class="search-box">
								...
								<input type="search" placeholder="직원이름을 입력하세요." name="keyword"
									class="search-box-text" value="" id="nkeyword"> <input
									type="submit" value="직원조회">
							</div>
						</div>
					</form>
				</div>
										...
										<tr data-parent="1" data-num="1" data-depth="1"
											...
											<td class="td-100">
												<div class="contents-input-div">
													...
													<input type="button" class="contents-input-btn noline"
														value="퇴사" id="deleteBtn_${ emp.empId }"
														onclick="onDelete(${ emp.empId }); return false;">
												</div>
											</td>
